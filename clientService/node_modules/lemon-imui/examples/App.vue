  ...
  <div id="app">
    ...
    <table class="table">
      ...
      <tr>
        <td>setAtUserList</td>
        <td>设置@人员的列表</td>
        <td>Function(UserList,callEvery)</td>
        <td>-</td>
...
export default {
  ...
  mounted() {
    ...
    const contactData4 = {
      ...
      displayName: "如花",
      avatar:
        "https://p.qqan.com/up/2021-1/2021122135507881.jpg",
      index: "",
      unread: 1,
      lastSendTime: 3,
      lastContent: "吃饭了嘛",
  ...
  methods: {
    ...
    handleChangeContact(contact, instance) {
      ...
      this.$refs.IMUI.setAtUserList([
        {
        id: '1',
        displayName: '张三',
        avatar: 'https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png',
        name_py: 'zhang san' // 如已有数据未支持，可以自行下载pinyin-pro以支持该交互效果
      },
      {
        id: '2',
        displayName: '李四',
